...
D="--positions data/positions_pilot_sf.jsonl.gz --init-weights data/train_gpu/model_step11600.pt --n-eval 512"
...
python -m flybrain.train --device cuda --positions data/positions_pilot_sf.jsonl.gz \
